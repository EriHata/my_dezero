...
#from my_dezero.utils import get_file, cache_dir
#from my_dezero.transforms import Compose, Flatten, ToFloat, Normalize
...
class MNIST(Dataset):
    ...
    def prepare(sehttps://itb-hdb2.htdb.jp/ggutk9a/recordList/list/dbgId/100026/dbSchemaId/100539lf):
